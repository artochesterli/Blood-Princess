    ...
    public class CraftingTable : MonoBehaviour
    {
        ...
        private class CraftTableOpenState : CraftTableState
        {
            ...
            public override void Update()
            {
                ...
                if (global::Utility.InputSelectDown(ControlState.CraftingTable))
                {
                ...
                if (global::Utility.InputSelectUp(ControlState.CraftingTable))
                {
                    int index = m_SelectionIndex - 1;
                    if (index < 0 || index > Context.CraftingPanel.transform.childCount - 1)
                        return;
                ...
                if (global::Utility.InputComfirm(ControlState.CraftingTable) && m_CanMakeCurrentSelection)
                {
